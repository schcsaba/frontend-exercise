...
funnelIcon.addEventListener("click", ()=>{
    ...
    /* Déclenche la prise de focus sur le premier lien du menu après la fin de la transition */ modal.addEventListener('transitionend', (ev)=>{
...
searchbarForm.addEventListener("submit", (ev)=>{
    ev.preventDefault();
    if (modal.classList.contains("modal__show")) modal.classList.remove("modal__show");
});

//# sourceMappingURL=index.84490b3b.js.map
